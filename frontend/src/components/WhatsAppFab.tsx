...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_28px_rgba(37,211,102,.45)] transition hover:scale-105"
    >
